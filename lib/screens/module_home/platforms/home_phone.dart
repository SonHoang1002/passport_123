...
import 'package:passport_photo_2/a_test/w_export_body.dart';
...
import 'package:passport_photo_2/helpers/remove_background.dart';
...
import 'package:passport_photo_2/screens/module_home/widgets/w_print.dart';
import 'package:passport_photo_2/screens/sub_modules/module_adjust/adjust_body_phone.dart';
import 'package:passport_photo_2/screens/sub_modules/module_crop/crop_body.dart';
import 'package:passport_photo_2/services/dio_api.dart';
...
import 'package:passport_photo_2/screens/sub_modules/module_finish/finish_body.dart';
import 'package:passport_photo_2/screens/sub_modules/module_import/import_body_phone.dart';
import 'package:passport_photo_2/widgets/w_circular.dart';
import 'package:passport_photo_2/widgets/w_header.dart';
...
class HomePagePhone extends StatefulWidget {
  ...
  HomePagePhone({super.key, required this.project});
  @override
...
class _HomePagePhoneState extends State<HomePagePhone>
    with
        ...
        AutomaticKeepAliveClientMixin<HomePagePhone> {
  // general
  late Size _size;
  ...
  // CustomBrightnessShaderConfiguration? _brightnessShaderConfiguration;
  // GroupShaderConfiguration? _groupShaderConvertedConfiguration;
  // crop properties
  ...
  void initState() {
    ...
    //   ..brightness = _projectModel.brightness;
  }
...
Future<void> _onNext() async {
  ...
  Future<void> _onPrint() async {
    double height = 330.0; //_size.height * 0.4;
    showCustomBottomSheetWithDragIcon(
      context: context,
      child: WPrintBody(
        height: height,
