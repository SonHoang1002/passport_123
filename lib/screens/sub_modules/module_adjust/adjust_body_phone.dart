...
class BodyAdjustPhone extends StatefulWidget {
  ...
  @override
  State<BodyAdjustPhone> createState() => _TestBodyAdjustPhoneState();
}

class _TestBodyAdjustPhoneState extends State<BodyAdjustPhone> {
  // constant
  ...
  //2
  // late CustomHighlightShadowShaderConfiguration
  //     _customHighlightShadowShaderConfiguration;
  ...
  AdjustSubjectModel get currentAdjustSubject =>
  ...
  /// [deltaOffset] is [-50,50]
  void _onUpdateBrightnessProperty(double deltaOffset) {
    consolelog("_onUpdateBrightnessProperty = $deltaOffset");
    double brightnessValue = deltaOffset / 100; // [-0.5, 0.5]
    _brightnessShaderConfiguration.brightness =
  ...
  void _onUpdateBrightnessForProjectModel(double brightnessValue) {
    if (_indexBackgroundSelected == 0) {
      ...
      ///
      double _deltaBlur = 0;
      double convertBrightness = brightnessValue - 0.5;

      double s1 = FlutterConvert.convertMappingRange(
        -(convertBrightness - _deltaBlur),
        -0.5 - _deltaBlur,
        0.5 + _deltaBlur,
        0.02,
        0.15,
  ...
  void _initShaderConfiguration() {
    ...
    _combineShaderCustomConfiguration.initValues();
  }
  ...
  Future<void> _onExportAdjust() async {
  ...
  Size _getImageSize() {
    double? imageHeight = (_sizeConvertedImage?.height) ?? 0;
    double? imageWidth = (_sizeConvertedImage?.width) ?? 0;
                            ...
                            child: Container(
                              ...
                              child: WRulerCustom(
                                ...
                                instructionRatioValue:
                                    currentAdjustSubject.rootRatioValue,
                                currentRatioValue:
                                    currentAdjustSubject.currentRatioValue,
                                dividers: currentAdjustSubject.dividers,
