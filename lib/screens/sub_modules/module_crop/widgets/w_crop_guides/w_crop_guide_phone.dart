...
class _WCustomCropGuidePhoneState extends State<WCustomCropGuidePhone> {
  ...
  void _updateImageSize(double width, double height) {
    _imageSizeOriginal ??=
        Size(_size.width * _mainRatio, _size.width * _mainRatio);
      ...
      child: Scaffold(
        ...
        body: Container(
          ...
          padding: EdgeInsets.only(
            ...
            top: (_size.width > MIN_SIZE.width ? 50 : 20) +
                        ...
                        children: [
                          ...
                          Positioned(
                            ...
                            child: Image.asset(
                              ...
                              width: 100,
                              color:
                                  _indexFacePositionSelected == 0 ? blue : null,
                            ),
                          ),
                          // crop chin limit icon
                          Positioned(
                            ...
                            child: Image.asset(
                              ...
                              width: 100,
                              color:
                                  _indexFacePositionSelected == 2 ? blue : null,
                            ),
                          ),
                          // line dash
                          Positioned(
                            ...
                            child: SizedBox(
                              ...
                              child: WLineDash(
                                color:
                                    _isDarkMode ? primaryDark1 : primaryLight1,
                              ),
                            ),
                          ),
                          // blue cursor
                          ...
                          if (_indexFacePositionSelected != 1)
                            Positioned(
                                ...
                                right: (_size.width * (1 - _mainRatio)) / 2 -
                                    20, // padding :20
        ...
        child: Row(
            ...
            children: LIST_POSITION_FACE.indexed.map((e) {
              ...
              return _buildFaceOptionItem(
                  index == _indexFacePositionSelected, e.$2, () {
