...
//           );
//           double imageWidth = (widthCropHole /
//               (1 - _cropModel.ratioLeftInImage - _cropModel.ratioRightInImage));
//           double imageHeight = (heightCropHole /
...
//     // scale vector đúng
//     Offset newCenterInImage = focalInImageCoord +
...
//       throw Exception("_renderBoxGestureArea is null");
//     }
//     final Offset convertedPositionInGestureCoor =
//         _renderBoxGestureArea!.globalToLocal(globalPosition);
...
//         Offset newImageCenterInGestureCoordinate =
//             _renderBoxGestureArea!.globalToLocal(
...
//         }
//         if (isHaveLimitWhenGesture) {
//           newRectInGestureCoordinate =
//               newRectInGestureCoordinate.limitSelfToInclude(
//             getRectCrop,
//             angleByRadian: angleByRadian,
...
//                               clipBehavior:
//                                   _isGesturingImage ? Clip.none : Clip.hardEdge,
//                               key: _keyImage,
//                             ),
//                           ),
//                           // rectangle frame
